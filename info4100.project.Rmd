...
test = combined %>%
  ...
  subset(select = c(hash_id, num_load_video, num_pause_video, num_speed_change_video, num_stop_video,
                ...
                num_slack_tab, is_submitted, earned_graded, num_stop_video, maximum_grade, avg_grade, points_off))
...
#cm_eval(cm_logreg)
#### overfitting log_reg
m_knn = knn(train = train[,c('maximum_grade','avg_grade', 'points_off')], 
            test = test[,c('maximum_grade','avg_grade', 'points_off')], 
