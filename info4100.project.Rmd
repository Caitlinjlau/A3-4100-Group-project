...
test = combined_ranked %>%
  ...
  subset(select = c(hash_id, num_load_video, num_pause_video, num_speed_change_video, num_stop_video,
                ...
                num_slack_tab, num_week_two_reading, num_week_five_reading, num_week_seven_reading, avg_grade, is_submitted))
...
plot(combined_ranked$avg_grade, combined_ranked$is_submitted) 
length(!is.na(combined_ranked$avg_grade))
table(combined_ranked$avg_grade)
length(combined_ranked$is_submitted)

cor(combined_ranked$avg_grade, combined_ranked$is_submitted)
###############################################
###############################################
```
...
m_logreg = glm(is_submitted ~ num_load_video + num_pause_video + num_speed_change_video + num_stop_video 
               + num_click_progress  + num_name_prob_submit +
                num_slack_tab  + num_week_five_reading + num_week_seven_reading
...
cm_linreg = table(true = test$is_submitted, predicted = p_linreg)
