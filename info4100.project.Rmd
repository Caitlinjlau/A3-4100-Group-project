...
#feature 11: did they do week 2 reading
...
#feature 12: did they do week 7 reading. 
...
# add code here
#Assuming higher timestamp means later time - Destiny
x <- sort(unique(new_unsubmit_tbl$deadline_minus_24), decreasing = TRUE)
y <- subset(new_unsubmit_tbl, new_unsubmit_tbl$deadline_minus_24 %in% x[1:4])
mod_ids_of_last_four <- unique(y$module_id)
mod_ids_of_last_four
